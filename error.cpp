...
const char *errmsg(int errt)
{
	...
	const char *list_messages[] = {
		...
		"Bad list for ctor!",
		"List logic address error!",
		"List nullptr data error!"
	};

	const char *hst_messages[] = {
		"Hashtable nullptr error!",
		"Hashtable null list error!",
		"Hashtable null buffer error!"
	};
	...
	case 2:
		...
		break;
	case 6:
		if (ERRNUM - 600 < HST_ERRS)
			return hst_messages[ERRNUM - 600];
		break;
	default:
